<template>
  <h3 
    :id="id" 
    class="relative text-xl text-base-content font-bold mt-8 mb-4 scroll-mt-[calc(48px+45px+var(--ui-header-height))] lg:scroll-mt-[calc(48px+var(--ui-header-height))] group"
  >
    <a 
      :href="`#${id}`" 
