<template>
  <h2 
    :id="id" 
    class="relative text-2xl text-base-content font-bold mt-12 mb-6 scroll-mt-[calc(48px+45px+var(--ui-header-height))] lg:scroll-mt-[calc(48px+var(--ui-header-height))] group"
  >
    <a 
      :href="`#${id}`" 
