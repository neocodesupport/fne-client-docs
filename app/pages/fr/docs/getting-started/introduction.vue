<template>
  <DocPage
    ...
    sub-description="Bienvenue dans la documentation de <strong>FNE Client</strong>, le SDK PHP framework-agnostic pour l'intégration de l'API FNE (Facture Normalisée Électronique)."
    section="Démarrage"
